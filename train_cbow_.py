    ...
    for epoch in range(100):
        ...
        for i, (context, target) in enumerate(train_loader):
            ...
            if (i+1) % 10 == 0:
                ...
                print('sim to athens : '+ str(pairwise_distance(result, model.get_word_embedding('athens'))))
                print('sim to greece : '+ str(pairwise_distance(result, model.get_word_embedding('greece'))))
                print('sim to baghdad : '+ str(pairwise_distance(result, model.get_word_embedding('baghdad'))))
                print('sim to iraq : '+ str(pairwise_distance(result, model.get_word_embedding('iraq'))))

                print('sim to france : '+str(torch.nn.functional.cosine_similarity(result, model.get_word_embedding('france'))))
